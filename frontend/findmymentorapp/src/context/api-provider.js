...
export function APIProvider(props) {
    ...
    async function getUserInfo() {
      ...
      async function register(firstName, lastName, email, password, biography, workLocation, isMentor, isMentee, yearsOfPractice, designation, zone, areaPractice, skills, areasInterest, mentorshipGoals) {
        // Send credentials to server and save the token from the response
        try {
